...
def load_vae():
    ...
    vae_decoder.eval().to(dtype=torch.float16).requires_grad_(False)
...
class GenerateParams:
    def __init__(self, **kwargs):
        ...
        self.num_denoising_steps = kwargs.get("num_denoising_steps", 4)
...
class GenerationSession:
    ...
    def __init__(self, params, config, debug=False, frame_callback=None, models=None):
