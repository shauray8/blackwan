...
import wan.modules.flash_attn.cute.utils as utils
from wan.modules.flash_attn.cute import copy_utils
import wan.modules.flash_attn.cute.pipeline as pipeline
from wan.modules.flash_attn.cute.mask import AttentionMask
from wan.modules.flash_attn.cute.softmax import SoftmaxSm100, apply_score_mod_inner
...
from wan.modules.flash_attn.cute import mma_sm100_desc as sm100_desc
from wan.modules.flash_attn.cute import blackwell_helpers as sm100_utils
...
class FlashAttentionForwardSm100:
    ...
    def __init__(
        ...
        assert self.num_stages in [2,3,4,5,6], "Stages 4-6 optimal for SM100"
