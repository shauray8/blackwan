...
class WanT2V:
    ...
    def __init__(
        ...
        print("Applying TaylorSeer caching...")
        self.low_noise_model = apply_cache_on_transformer(self.low_noise_model)
        self.high_noise_model = apply_cache_on_transformer(self.high_noise_model)
        print("Caching enabled on both models.")
    ...
    def generate(self,
                 ...
                 taylorseer_n_derivatives: int = 2,
        ...
        cache_kwargs = {
            "n_derivatives": taylorseer_n_derivatives,
            "warmup_steps": taylorseer_warmup_steps,
            "skip_interval_steps": taylorseer_skip_interval,
        }
        ...
        with utils.cache_context(
            utils.create_cache_context(
                ...
                taylorseer_kwargs=cache_kwargs,
